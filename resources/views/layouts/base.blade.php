				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 999 999" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+123) 999 999</a>
								</li>
							</ul>
						</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											...
											<li>
												...
												<p class="contact-txt">(+123) 999 999 - (+123) 999 888</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+123) 999 999 - (+123) 999 888</b>
									</div>
								</div>
							</div>
